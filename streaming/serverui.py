...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.logs.setGeometry(QtCore.QRect(10, 30, 491, 251))
        ...
        self.label_2.setGeometry(QtCore.QRect(20, 296, 58, 15))
        self.label_2.setObjectName("label_2")
        self.port_textedit = QtWidgets.QTextEdit(self.centralwidget)
        self.port_textedit.setEnabled(True)
        self.port_textedit.setGeometry(QtCore.QRect(60, 290, 131, 30))
        self.port_textedit.setObjectName("port_textedit")
        self.start_button = QtWidgets.QPushButton(self.centralwidget)
        self.start_button.setGeometry(QtCore.QRect(270, 290, 93, 30))
        self.start_button.setObjectName("start_button")
        self.stop_button = QtWidgets.QPushButton(self.centralwidget)
        self.stop_button.setEnabled(False)
        self.stop_button.setGeometry(QtCore.QRect(370, 290, 93, 30))
        self.stop_button.setObjectName("stop_button")
        self.about_button = QtWidgets.QPushButton(self.centralwidget)
        self.about_button.setGeometry(QtCore.QRect(470, 290, 30, 30))
